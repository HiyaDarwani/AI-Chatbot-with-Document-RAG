...
Answer based only on the context above. Cite source numbers.`;
  ...
  if (isMockMode()) {
    try {
      const sentences = [
        "Based on the simulated document context, here is what I found:\n\n",
        "According to **Source 1**, the document covers main components of the uploaded document. ",
        "Specifically, the text references operating patterns and core properties. ",
        "Additionally, **Source 2** details how features integrate together.\n\n",
        "Please let me know if you would like me to extract any further information!"
      ];

      const fullResponseText = sentences.join("");
